...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-5">
            ...
            <div className="flex items-center justify-between w-full md:w-auto gap-4">
              ...
              <button 
                ...
                className="text-white p-1 md:hidden hover:bg-white/10 rounded-lg transition-colors"
              >
                <Menu size={28} />
              </button>
              ...
              {/* أيقونات سريعة للموبايل (سلة ويوزر) */}
            ...
            <div className="flex-1 w-full max-w-2xl relative">
              <div className="relative group">
                <input
                  ...
                  className="w-full h-10 md:h-11 pl-4 pr-12 rounded-xl border-none focus:ring-2 focus:ring-yellow-400 text-sm font-medium"
                />
            ...
            <div className="overflow-y-auto h-full pb-32">
              ...
              <div className="p-6 text-center">
                 ...
                 <div className="flex justify-center gap-4">
                    <img src="/img/apple-store.webp" alt="ios" className="h-8" />
                    <img src="/img/google-play.webp" alt="android" className="h-8" />
                 </div>
              </div>
            </div>
          </div>
      ...
      {/* الـ Dropdown المنبثق للموبايل عند الضغط على أيقونة المستخدم */}
      {isUserMenuOpen && (
