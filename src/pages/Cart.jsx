              ...
              <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                {cartItems.length === 0 ? (
                  ...
                  <div className="p-12 md:p-20 flex flex-col items-center text-center">
                    ...
                    <Link to="/" className="bg-[#1e40af] text-white px-8 py-3 rounded-xl font-bold uppercase text-xs flex items-center gap-2 hover:bg-blue-800 transition-all">
                  ...
                  <div className="divide-y divide-gray-50">
                    {cartItems.map((item) => (
                      <div key={item.id} className="p-4 md:p-6 flex gap-4 md:gap-6 items-center">
                        ...
                        <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                            <h4 className="text-xs md:text-sm font-bold text-gray-800 line-clamp-2 md:max-w-xs">{item.name}</h4>
                            <p className="text-[#1e40af] font-black text-sm md:text-base mt-1">{item.price}</p>
                          </div>
                          ...
                          <div className="flex items-center justify-between md:justify-end gap-6">
                            ...
                            <div className="flex items-center bg-gray-100 rounded-lg px-2 py-1 border border-gray-200">
                              ...
                              <span className="px-3 font-bold text-sm text-[#1e40af]">{item.quantity || 1}</span>
                              <button 
                    ...
                    <div className="p-4 bg-gray-50 flex justify-end">
                      <button onClick={clearCart} className="text-[10px] font-bold text-red-500 uppercase hover:underline">Clear Cart</button>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <div className="bg-blue-50/50 p-4 rounded-2xl flex items-center gap-4 border border-blue-100">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-blue-600/70 uppercase">Orders over QAR 500</p>
                    </div>
                 </div>
